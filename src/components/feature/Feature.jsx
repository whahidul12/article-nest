      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">
            Powerful features designed to make reading, learning, and discovering content
            effortless.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div className="md:p-8 lg:p-14">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Clarity</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              Every article is written with a clear structure and simple language, so you
              understand ideas faster without unnecessary complexity.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Depth</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              We go beyond surface-level content to deliver meaningful insights that help
              you truly grasp the topic and apply it in real life.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Trust</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              Content is carefully researched and thoughtfully presented, so you can rely
              on what you read and share it with confidence.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Designed to help you learn continuously, expand your perspective, and grow
              smarter with every article you read.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Relevance</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              Articles are curated around real-world problems, trends, and ideas that
              matter to modern readers and professionals.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Focus</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              Content is carefully researched and thoughtfully presented, so you can rely
              on what you read and share it with confidence.
            </p>
